...
class responderpolicy_responderpolicylabel_binding(base_resource) :
	...
	@property
	def name(self) :
		ur"""Name of the responder policy for which to display settings.
		"""
		try :
			return self._name
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch responderpolicy_responderpolicylabel_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of responderpolicy_responderpolicylabel_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count responderpolicy_responderpolicylabel_binding resources configued on NetScaler.
		"""
		try :
			obj = responderpolicy_responderpolicylabel_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of responderpolicy_responderpolicylabel_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = responderpolicy_responderpolicylabel_binding()
