...
class cachepolicy_cacheglobal_binding(base_resource) :
	...
	def get(cls, service, policyname) :
		ur""" Use this API to fetch cachepolicy_cacheglobal_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, policyname, filter_) :
		ur""" Use this API to fetch filtered set of cachepolicy_cacheglobal_binding resources.
	...
	def count(cls, service, policyname) :
		ur""" Use this API to count cachepolicy_cacheglobal_binding resources configued on NetScaler.
		"""
		try :
			obj = cachepolicy_cacheglobal_binding()
			obj.policyname = policyname
	...
	def count_filtered(cls, service, policyname, filter_) :
		ur""" Use this API to count the filtered set of cachepolicy_cacheglobal_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cachepolicy_cacheglobal_binding()
