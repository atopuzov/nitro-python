...
class vpnvserver_intranetip_binding(base_resource) :
	...
	@property
	def intranetip(self) :
		ur"""The network ID for the range of intranet IP addresses or individual intranet IP addresses to be bound to the virtual server.
		"""
		try :
	...
	@property
	def netmask(self) :
		ur"""The netmask of the intranet IP address or range.
		"""
		try :
	...
	def get(cls, service, name) :
		ur""" Use this API to fetch vpnvserver_intranetip_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		ur""" Use this API to fetch filtered set of vpnvserver_intranetip_binding resources.
	...
	def count(cls, service, name) :
		ur""" Use this API to count vpnvserver_intranetip_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnvserver_intranetip_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		ur""" Use this API to count the filtered set of vpnvserver_intranetip_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnvserver_intranetip_binding()
