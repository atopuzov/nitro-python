...
class transformglobal_transformpolicy_binding(base_resource) :
	...
	@property
	def policyname(self) :
		ur"""Name of the transform policy.
		"""
		try :
	...
	@property
	def labelname(self) :
		ur"""Name of the policy label to invoke if the current policy evaluates to TRUE, the invoke parameter is set, and the label type is Policy Label.
		"""
		try :
	...
	@property
	def invoke(self) :
		ur"""If the current policy evaluates to TRUE, terminate evaluation of policies bound to the current policy label, and then forwards the request or response to the specified virtual server or evaluates the specified policy label.
		"""
		try :
			return self._invoke
		except Exception as e:
	...
	@property
	def type(self) :
		ur"""Specifies the bind point to which to bind the policy. Available settings function as follows:
	...
	@property
	def flowtype(self) :
		ur"""flowtype of the bound transform policy.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a transformglobal_transformpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of transformglobal_transformpolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count transformglobal_transformpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = transformglobal_transformpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of transformglobal_transformpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = transformglobal_transformpolicy_binding()
