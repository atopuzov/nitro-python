...
class appflowglobal_appflowpolicy_binding(base_resource) :
	...
	@property
	def labeltype(self) :
		ur"""Type of policy label to invoke. Specify vserver for a policy label associated with a virtual server, or policylabel for a user-defined policy label.<br/>Possible values = vserver, policylabel.
		"""
		try :
	...
	@property
	def flowtype(self) :
		ur"""Flow type of the bound AppFlow policy.
		"""
		try :
	...
	@classmethod
	def get(cls, service) :
		ur""" Use this API to fetch a appflowglobal_appflowpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		ur""" Use this API to fetch filtered set of appflowglobal_appflowpolicy_binding resources.
	...
	def count(cls, service) :
		ur""" Use this API to count appflowglobal_appflowpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = appflowglobal_appflowpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		ur""" Use this API to count the filtered set of appflowglobal_appflowpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = appflowglobal_appflowpolicy_binding()
